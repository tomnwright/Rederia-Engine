...
class main(tkinter.Frame):
    ...
    def __init__(self, master=None,object_list = []):
        ...
        self.choice_frame = tkinter.Frame(self.master, bg = Style.colour.bw[2])
    ...
    def init_top(self, frame):
        ...
        self.btn_rot = LabeledWidget.Label(1,frame, image = self.imgs.rotate, bg = Style.colour.bw[1])
        self.btn_sca = LabeledWidget.Label(2,frame, image = self.imgs.scale, bg = Style.colour.bw[1])
    ...
    def select_btn(self, event):
        ...
        self.active.config(bg = Style.colour.bw[1])
        self.active = widget
